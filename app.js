...
function subscribeMarket(){
  ...
  S.engineHistoryReq=++S.req;S.engineCandles=[];S.engineHistoryReady=false;send({ticks_history:S.symbol,count:300,end:'latest',style:'candles',granularity:S.engineTimeframe,req_id:S.engineHistoryReq});
